...
echo "<script type='text/javascript'> document.location = 'perfil'; </script>";
} else{
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form method="post">
									...
									<label for="" class="text-uppercase text-sm">Seu email</label>
								...
								<br>
								<p>Não possui uma conta? <a href="register" >Cadastra - se</a></p>
							</div>
						</div>
					</div>
				</div>
