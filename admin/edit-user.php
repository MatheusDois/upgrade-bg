	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h3 class="page-title">Editar Usuário : <?php echo htmlentities($result->name); ?></h3>
						<div class="row">
							<div class="col-md-12">
...
<div class="form-group">
<label class="col-sm-2 control-label">Gênero<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Designação<span style="color:red">*</span></label>
<div class="col-sm-4">
