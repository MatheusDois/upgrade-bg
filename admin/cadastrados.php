			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Lista de Cadastrados</h2>
...
{				?>	
										<tr>
                                            ...
                                            <?php if($result->status == 1)
                                                    {?>
                                                    <a href="cadastrados?confirm=<?php echo htmlentities($result->id);?>" onclick="return confirm('Deseja realmente cancelar a confirmação da conta?')">Confirmado <i class="fa fa-check-circle"></i></a> 
                                                    <?php } else {?>
                                                    <a href="cadastrados?unconfirm=<?php echo htmlentities($result->id);?>" onclick="return confirm('Deseja realmente confirmar a conta?')">Não Confirmado <i class="fa fa-times-circle"></i></a>
                                                    <?php } ?>
</td>
                                            </td>
